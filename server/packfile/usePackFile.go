...
func writeFile(path string, data []byte) {
	// If the folder does not exist, create the folder in advance
	...
	// Existing files should not be overwritten or rewritten, the configuration file may be changed on the front end, etc.
